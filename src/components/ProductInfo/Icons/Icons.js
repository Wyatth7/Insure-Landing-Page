...
const PEOPLE = styled.svg``;
export const PeopleFirst = (props) => {
  return (
    <PEOPLE xmlns="http://www.w3.org/2000/svg" width="86" height="86">
...
const LIGHTNING = styled.svg``;
export const Lightning = (props) => {
  return (
    <LIGHTNING xmlns="http://www.w3.org/2000/svg" width="86" height="86">
      <g fill="none" fill-rule="evenodd">
        <circle cx="43" cy="43" r="43" fill="#96A9C6" />
        <path
          fill="#FFF"
...
const MONEY = styled.svg``;
export const Money = (props) => {
  return (
    <MONEY xmlns="http://www.w3.org/2000/svg" width="86" height="86">
      <g fill="none" fill-rule="evenodd">
        <circle cx="43" cy="43" r="43" fill="#96A9C6" />
        <path
          fill="#FFF"
